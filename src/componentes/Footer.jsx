    ...
    <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
      ...
      <div className="col mb-3">
        ...
        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
          <li className="ms-3"><a className="text-muted" href="https://instagram.com/campingquemquem?igshid=OGQ2MjdiOTE="><svg className="bi" width={24} height={24}><use xlinkHref="#instagram" /></svg></a></li>
