  ...
  return (
    <div className="container text-center d-flex align-items-center justify-content-center p-5 " id="ubicacion">
      <div className="row">
        ...
        <div className=" container col-12 col-lg-6 mapa-texto">
              <h2 className="titulo text-center">Cómo Llego</h2>
                  <p className='m-2'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam omnis dolor aliquid unde iure necessitatibus inventore, soluta officiis accusantium assumenda tenetur magni quo error ut iusto facere blanditiis, saepe quasi.
